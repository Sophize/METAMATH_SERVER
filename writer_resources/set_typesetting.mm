...
htmldef "Mgm" as 'Mgm';
 ...
 latexdef "Mgm" as "{\rm Mgm}";
htmldef "SGrp" as 'SGrp';
 althtmldef "SGrp" as 'SGrp';
 latexdef "SGrp" as "{\rm SGrp}";
htmldef "MndOLD" as 'MndOLD';
 althtmldef "MndOLD" as 'MndOLD';
 latexdef "MndOLD" as "{\rm MndOLD}";
htmldef "Mnd" as
...
htmldef "repeatS" as ' repeatS ';
  ...
  latexdef "repeatS" as "{\rm repeatS}";
...
htmldef "pmEven" as "pmEven";
  ...
  latexdef "pmEven" as "\mathrm{pmEven}";
...
htmldef "ZZring" as "&#8484;<SUB>ring</SUB>";
  ...
  latexdef "ZZring" as "{\rm ZZring}";
htmldef "RR^" as "&#8477;^";
  althtmldef "RR^" as "&#8477;^";
  latexdef "RR^" as "{\rm RR^}";
htmldef "EEhil" as "&#x1D53C;<SUB>hil</SUB>";
  althtmldef "EEhil" as "&#x1D53C;<SUB>hil</SUB>";
  latexdef "EEhil" as "{\rm EEhil}";
htmldef "ZRHom" as
...
htmldef "DMat" as ' DMat ';
  ...
  latexdef "DMat" as "{\rm DMat}";
htmldef "ScMat" as ' ScMat ';
  althtmldef "ScMat" as ' ScMat ';
  latexdef "ScMat" as "{\rm ScMat}";
...
htmldef "toCHil" as "toCHil";
  althtmldef "toCHil" as "to&#8450;Hil";
  latexdef "toCHil" as "{\mathrm{to}\mathbb{C}\mathrm{Hil}}";
...
htmldef "USHGrph" as ' USHGrph ';
  althtmldef "USHGrph" as ' USHGrph ';
  latexdef "USHGrph" as "{\rm USHGrph}";
htmldef "UMGrph" as " UMGrph ";
  althtmldef "UMGrph" as " UMGrph ";
...
htmldef "Edges" as ' Edges ';
 althtmldef "Edges" as ' Edges ';
 latexdef "Edges" as "{\rm Edges}";
...
htmldef "VDeg" as " VDeg ";
  althtmldef "VDeg" as " VDeg ";
...
htmldef "WalkOn" as " WalkOn ";
  althtmldef "WalkOn" as " WalkOn ";
  latexdef "WalkOn" as " {\rm WalkOn} ";
htmldef "TrailOn" as " TrailOn ";
  althtmldef "TrailOn" as " TrailOn ";
  latexdef "TrailOn" as " {\rm TrailOn} ";
htmldef "PathOn" as " PathOn ";
  althtmldef "PathOn" as " PathOn ";
...
htmldef "seqstr" as "seq<SUB>str</SUB>";
  ...
  latexdef "seqstr" as "\rm{sgn}_str";
htmldef "Fibci" as "Fibci";
  althtmldef "Fibci" as "Fibci";
  latexdef "Fibci" as "{\rm Fibci}";
...
htmldef "Prv" as "Prv ";
  ...
  latexdef "Prv" as "{\rm Prv}";
htmldef "FF/" as "FF/";
    althtmldef "FF/" as "&#8498;&#8498;";
    latexdef "FF/" as "\Finv\Finv";
htmldef "sngl" as "sngl ";
  althtmldef "sngl" as "sngl ";
  latexdef "sngl" as "{\rm sngl}";
htmldef "tag" as "tag ";
  althtmldef "tag" as "tag ";
  latexdef "tag" as "{\rm tag}";
htmldef "(|" as "(|";
  althtmldef "(|" as "&#x2985;";
  latexdef "(|" as "\lParen";
htmldef "|)" as "|)";
...
htmldef "curry_" as "curry_";
  ...
  latexdef "curry_" as "\mathrm{curry}";
htmldef "uncurry_" as "uncurry_";
  althtmldef "uncurry_" as "uncurry_";
  latexdef "uncurry_" as "\mathrm{uncurry}";
htmldef "Diag" as "Diag";
  althtmldef "Diag" as "Diag";
  latexdef "Diag" as "\mathrm{Diag}";
...
htmldef "prcpal" as "prcpal";
  althtmldef "prcpal" as "prcpal";
  latexdef "prcpal" as "\mathrm{prcpal}";
htmldef "Arg" as "Arg";
  althtmldef "Arg" as "Arg";
  latexdef "Arg" as "\mathrm{Arg}";
...
htmldef "inftyexpi" as "inftyexpi ";
  althtmldef "inftyexpi" as "inftyexpi ";
  latexdef "inftyexpi" as "\mathrm{inftyexpi} ";
